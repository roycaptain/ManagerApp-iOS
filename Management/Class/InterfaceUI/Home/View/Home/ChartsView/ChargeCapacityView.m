...
@implementation ChargeCapacityView
...
-(void)updateCapacityWithChargeQuantity:(ChargeQuantityModel *)model
{
    ...
    [self setContentWithText:[NSString stringWithFormat:@"%.2f",model.totalQuantity]];
    ...
    .gradientColorsThemeEnabledSet(false)
    .yAxisTitleSet(@"")
...
{
    NSMutableAttributedString *firstAttri = [[NSMutableAttributedString alloc] initWithString:@"累计充电量(kW/h): "];
